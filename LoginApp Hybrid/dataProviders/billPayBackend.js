...
(function() {
    var provider = app.data.billPayBackend = new Everlive({
            offlineStorage: true,
            apiKey: 'nr5TBozhdulaq9Vt',
    ...
    document.addEventListener('online', function() {
        app.data.billPayBackend.offline(false);
        app.data.billPayBackend.sync();
    });

    document.addEventListener('offline', function() {
        app.data.billPayBackend.offline(true);
    });

}());

// START_CUSTOM_CODE_billPayBackend
// END_CUSTOM_CODE_billPayBackend